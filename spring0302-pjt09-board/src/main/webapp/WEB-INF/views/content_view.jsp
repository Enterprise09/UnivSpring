...
<body>
	<P>
		<img src="/board/resources/title/modify_view.png">
	</P>
		...
		<form action="modify" method="post" id="frm">
			...
			<tr>
				...
				<td><input type="text" name="b_name"
					value="${content_view.b_name}"></td>
			</tr>
			<tr>
				<td>제목</td>
				<td><input type="text" name="b_subject"
					value="${content_view.b_subject}"></td>
			</tr>
			<tr>
				<td>내용</td>
			...
			<tr>
				<td colspan="2">
					<a href="#" onclick="document.getElementById('frm').submit();">
						<img src="/board/resources/mod_b.gif" />
					</a> &nbsp;&nbsp; 
					
					<a href="list">
						<img src="/board/resources/list_b.gif">
					</a> &nbsp;&nbsp; 
					
					<a href="delete?b_no=${content_view.b_no}">
						<img src="/board/resources/del_b.gif">
					</a> &nbsp;&nbsp; 
					
					<a href="reply_view?b_no=${content_view.b_no}"></a>
				</td>
